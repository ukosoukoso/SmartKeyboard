...
class KeyboardViewController: UIInputViewController {
    ...
    override func viewDidLoad() {
        ...
        // 初始化服务（不需要 API Key，直接调用服务器）
        openAIService = OpenAIService(serverURL: "http://your-company-server.com:8000")
    ...
    @objc func generateSuggestions() {
        ...
        Task {
            do {
                let suggestions = try await openAIService.generateSuggestions(context: context, style: "幽默风趣")
